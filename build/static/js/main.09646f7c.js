/*! For license information please see main.09646f7c.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
            ...
            if (null === a) $r(e, t, r, Kt, n), Dt(e, r);
              ...
              (function (e, t, n, r, a) {
                switch (t) {
                  ...
                  case "pointerover":
                    var l = a.pointerId;
                    return Ot.set(l, jt(Ot.get(l) || null, e, t, n, r, a)), !0;
                  case "gotpointercapture":
                    return (
                      (l = a.pointerId),
        ...
        function _o(e, t, n, r) {
          (t.value = n), (t.getSnapshot = r), To(t) && Po(e);
        }
        function No(e, t, n) {
          return n(function () {
            To(t) && Po(e);
        ...
        function ui(e, t, n, r) {
          ...
          "object" === typeof l && null !== l
            ? (a.context = Rl(l))
            : ((l = La(t) ? Ra : Ta.current), (a.context = Oa(e, l))),
        ...
        var Eu,
          ...
          Zu = 0;
        function es() {
          return 0 !== (6 & Tu) ? Ye() : -1 !== Gu ? Gu : (Gu = Ye());
        }
        function ts(e) {
          return 0 === (1 & e.mode)
            ? 1
        ...
        function as(e, t) {
          if (((Gu = -1), (Zu = 0), 0 !== (6 & Tu))) throw Error(l(327));
          var n = e.callbackNode;
        ...
        function gs(e, t) {
          ...
          if ((_l(), (Tu = n), (Cu.current = r), null !== Ru))
            throw Error(l(261));
  ...
  (n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".37753ddd.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunktodo = self.webpackChunktodo || []);
  ...
  const g = d("string"),
    ...
    x = f("FileList"),
    C = f("URLSearchParams"),
    [_, N, T, P] = ["ReadableStream", "Request", "Response", "Headers"].map(f);
  function R(e, t) {
    let n,
      r,
      { allOwnKeys: a = !1 } =
  ...
  const G = $.toFlatObject($, {}, null, function (e) {
          ...
          return (
            ...
            i.forEach(function (e, r) {
              !$.isUndefined(e) &&
                null !== e &&
                t.append(
                  !0 === o ? Y([n], r, l) : null === o ? n : n + "[]",
                  u(e)
                );
            }),
            !1
          );
      return !!J(e) || (t.append(Y(a, n, l), u(e)), !1);
    }
    const c = [],
      f = Object.assign(G, {
        defaultVisitor: s,
  ...
  const oe = class {
    ...
    ce =
      ...
      se && ["ReactNative", "NativeScript", "NS"].indexOf(fe) < 0);
  var fe;
  const de =
  ...
  const ge = {
    ...
    transformRequest: [
      function (e, t) {
        ...
        if ($.isFormData(e)) return r ? JSON.stringify(me(e)) : e;
        if (
          $.isArrayBuffer(e) ||
          $.isBuffer(e) ||
          $.isStream(e) ||
          ...
          try {
            ...
            if (n) {
              if ("SyntaxError" === a.name)
                throw K.from(a, K.ERR_BAD_RESPONSE, this, null, this.response);
              throw a;
            }
          }
        }
  ...
  function ke(e) {
    return !1 === e || null == e ? e : $.isArray(e) ? e.map(ke) : String(e);
  }
  ...
  Ee.accessor([
    ...
    $.reduceDescriptors(Ee.prototype, (e, t) => {
      let { value: n } = e,
  ...
  const je = (e) => (e instanceof xe ? { ...e } : e);
  function Ae(e, t) {
    t = t || {};
    const n = {};
    function r(e, t, n) {
  ...
  const Me = (e) => {
      ...
      if (
        ...
        (t.url = le(De(t.baseURL, t.url), e.params, e.paramsSerializer)),
        u &&
          i.set(
            "Authorization",
            "Basic " +
      ...
      if (
        ...
        (a && $.isFunction(a) && (a = a(t)), a || (!1 !== a && ze(t.url)))
      ) {
        const e = l && o && Fe.read(o);
        e && i.set(l, e);
      }
      return t;
    },
    Ue =
      ...
      function (e) {
        return new Promise(function (t, n) {
          const r = Me(e);
          let a = r.data;
          const l = xe.from(r.headers).normalize();
          let o,
            { responseType: i } = r;
          function u() {
          ...
          s.open(r.method.toUpperCase(), r.url, !0),
            ...
            (s.onabort = function () {
              s &&
                (n(new K("Request aborted", K.ECONNABORTED, r, s)), (s = null));
            }),
            (s.onerror = function () {
              n(new K("Network Error", K.ERR_NETWORK, r, s)), (s = null);
            }),
            ...
            "function" === typeof r.onDownloadProgress &&
              s.addEventListener("progress", Le(r.onDownloadProgress, !0)),
            "function" === typeof r.onUploadProgress &&
              s.upload &&
              s.upload.addEventListener("progress", Le(r.onUploadProgress)),
            (r.cancelToken || r.signal) &&
              ((o = (t) => {
                s &&
                  (n(!t || t.type ? new Te(null, e, s) : t),
                  s.abort(),
                  (s = null));
              }),
    ...
    Ie = (e, t) => {
      ...
      const a = function (e) {
        if (!n) {
          ...
          r.abort(
            t instanceof K ? t : new Te(t instanceof Error ? t.message : t)
          );
        }
      };
      let l =
        t &&
        setTimeout(() => {
          a(new K(`timeout ${t} of ms exceeded`, K.ETIMEDOUT));
        }, t);
      const o = () => {
        e &&
          (l && clearTimeout(l),
    ...
    Ve = (e, t, n, r, a) => {
      const l = (async function* (e, t, n) {
        for await (const r of e)
          yield* Be(ArrayBuffer.isView(r) ? r : await n(String(r)), t);
      })(e, t, a);
      let o = 0;
    ...
    We = $e && "function" === typeof ReadableStream,
    qe =
      $e &&
      ("function" === typeof TextEncoder
        ? ((Qe = new TextEncoder()), (e) => Qe.encode(e))
  ...
  const Ke =
    ...
    Xe = { stream: Je && ((e) => e.body) };
  var Ye;
  $e &&
    ((Ye = new Response()),
    ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
      !Xe[e] &&
        (Xe[e] = $.isFunction(Ye[e])
          ? (t) => t[e]()
          : (t, n) => {
              throw new K(
          ...
          try {
            if (
              ...
              $.isFormData(r) &&
                ...
                c.setContentType(e),
                n.body && (r = Ve(n.body, 65536, He(v, Le(u)), null, qe));
            }
            ...
            let a = await fetch(h);
            const l = Je && ("stream" === s || "response" === s);
            if (Je && (i || l)) {
              const e = {};
              ...
              a = new Response(
                Ve(a.body, 65536, i && He(t, Le(i, !0)), l && y, qe),
                e
              );
            }
            s = s || "text";
            let o = await Xe[$.findKey(Xe, s) || "text"](a, e);
            return (
              !l && y(),
              g && g(),
            ...
            if ((y(), b && "TypeError" === b.name && /fetch/i.test(b.message)))
              throw Object.assign(new K("Network Error", K.ERR_NETWORK, e, h), {
                cause: b.cause || b,
              });
            throw K.from(b, b && b.code, e, h);
          }
        }),
    };
  $.forEach(Ze, (e, t) => {
    ...
    nt = (e) => {
      ...
      for (let l = 0; l < t; l++) {
        ...
        if (
          ((n = e[l]),
          (r = n),
          !tt(n) && ((r = Ze[(t = String(n)).toLowerCase()]), void 0 === r))
        )
  ...
  function at(e) {
    ...
    return nt(e.adapter || ye.adapter)(e).then(
      function (t) {
        return (
          rt(e),
      ...
      assertOptions: function (e, t, n) {
        ...
        for (; a-- > 0; ) {
          ...
          if (o) {
            ...
            throw new K("Unknown option " + l, K.ERR_BAD_OPTION);
        }
      },
      validators: ot,
    },
  ...
  class ct {
    ...
    getUri(e) {
      return le(
        De((e = Ae(this.defaults, e)).baseURL, e.url),
        e.params,
        e.paramsSerializer
      );
    }
  ...
  $.forEach(["delete", "get", "head", "options"], function (e) {
    ct.prototype[e] = function (t, n) {
      return this.request(
        Ae(n || {}, { method: e, url: t, data: (n || {}).data })
      );
    };
  }),
  ...
  const gt = (function e(t) {
    const n = new ft(t),
      r = o(ft.prototype.request, n);
    return (
      $.extend(r, ft.prototype, n, { allOwnKeys: !0 }),
  ...
  (gt.Axios = ft),
    ...
    (gt.mergeConfig = Ae),
    (gt.AxiosHeaders = xe),
    (gt.formToJSON = (e) => me($.isHTMLForm(e) ? new FormData(e) : e)),
    (gt.getAdapter = nt),
    (gt.HttpStatusCode = mt),
    (gt.default = gt);
  const yt = gt;
  var vt = n(579);
  const bt = (e) => {
      ...
      return (0, vt.jsxs)("div", {
        className:
          "flex flex-col items-center justify-center mx-4 mt-11 border border-gray-300 rounded shadow-lg overflow-hidden",
        children: [
          (0, vt.jsx)("h2", {
            className: "font-mono text-3xl mb-4 mt-3",
          ...
          (0, vt.jsxs)("form", {
            onSubmit: (e) => {
              e.preventDefault(),
                n &&
                  l &&
                  (t({ title: n, description: l, completed: !1 }),
                  r(""),
                  o(""));
            },
            ...
            children: [
              (0, vt.jsx)("label", {
                htmlFor: "task",
                className: "text-xl ml-1 my-1 font-mono",
                children: "Task",
              }),
              (0, vt.jsx)("input", {
                name: "task",
                ...
                className:
                  "w-full p-2 text-lg mb-4 border border-gray-300 rounded font-mono",
              }),
              (0, vt.jsx)("label", {
              ...
              (0, vt.jsx)("textarea", {
                ...
                className:
                  "w-full p-2 mb-4 border border-gray-300 rounded font-mono",
              }),
              (0, vt.jsx)("div", {
                className: "flex justify-center items-center",
                children: (0, vt.jsx)("button", {
                  type: "submit",
                  className:
                    "w-full md:w-3/7 font-mono text-center p-2 bg-green-600 text-white rounded hover:bg-green-700 transition duration-200 text-xl",
                  children: "Add Task",
                }),
              }),
            ],
    ...
    wt = (e) => {
      let { tasks: t, deleteTask: n, updateTask: r } = e;
      return (0, vt.jsxs)("div", {
            ...
            : (0, vt.jsx)("div", {
                ...
                children: t.map((e) =>
                  (0, vt.jsxs)(
                    ...
                    {
                      className:
                        "task border border-gray-300 p-4 rounded shadow-lg overflow-hidden",
                      children: [
                        (0, vt.jsx)("h3", {
                          className:
                            "text-lg font-semibold font-mono " +
                            (e.completed ? "red-line" : ""),
                          children: e.title,
                        }),
                        (0, vt.jsx)("p", {
                          className:
                        ...
                        (0, vt.jsxs)("div", {
                          ...
                          children: [
                            (0, vt.jsx)("button", {
                              onClick: () =>
                                r(e._id, { completed: !e.completed }),
                              className:
                                "text-blue-500 hover:underline font-mono",
                            ...
                            (0, vt.jsx)("button", {
                              onClick: () => n(e._id),
                              className:
                                "text-red-500 hover:underline font-mono",
                              children: "Delete",
                            }),
                          ],
                        }),
    ...
    Et = () => {
      const [e, t] = (0, a.useState)([]),
        n = async () => {
          try {
            const e = await yt.get(St);
            t(e.data), console.log("Fetched tasks:", e.data);
          } catch (e) {
      ...
      return (
        ...
        (0, vt.jsxs)(kt, {
          children: [
            (0, vt.jsx)(bt, {
              addTask: async (e) => {
                await yt.post(St, e), console.log(e.data), n();
              },
            }),
            (0, vt.jsx)(wt, {
              tasks: e,
  ...
  const xt = function () {
      return (0, vt.jsxs)(vt.Fragment, {
        children: [
          (0, vt.jsx)("h1", {
            className: "text-center mt-4 font-mono text-6xl ",
            children: "To Do List",
          }),
          (0, vt.jsx)(Et, {}),
        ],
  ...
  l
    ...
    .render((0, vt.jsx)(a.StrictMode, { children: (0, vt.jsx)(xt, {}) })),
    Ct();
})();
//# sourceMappingURL=main.09646f7c.js.map
